...
<body>
    <!-- Halaman YES -->
    <section id="judul-yes">
        <div class="container">
            <div class="row text-center">
                <div class="col">
                    <h2> <b>YES</b> (Yakin Esok Sampai)</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center ">
                    <div class="cek-biaya-yes">
                        <h5>Hitung estimasi biaya pengiriman paket anda <br>
                            dengan layanan <b>YES</b></h5>
                        <p>
                        ...
                        <div class="row text-center">
                            <div class="col-lg-12">
                                <p>
                                    ...
                                    <a href="./Informasi.html"><button type="button" class="btn btn-warning">Cek
                                            Biaya</button></a>
                                </p>
                            </div>
                        </div>
